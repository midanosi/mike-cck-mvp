...
export type DishOfTheDayResponse<Texpand = unknown> = Required<DishOfTheDayRecord> & BaseSystemFields<Texpand>
export type MealRecipientResponse<Texpand = unknown> = Required<MealRecipientRecord> & BaseSystemFields<Texpand>
...
export type VolunteerResponse<Texpand = unknown> = Required<VolunteerRecord> & BaseSystemFields<Texpand>
export type VolunteerStatsResponse<Texpand = unknown> = Required<VolunteerStatsRecord> & BaseSystemFields<Texpand>
